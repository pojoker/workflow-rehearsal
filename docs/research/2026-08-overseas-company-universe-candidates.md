...
本轮先落入 7 条能改变产能、供应或商业阶段判断的原子事件，而非把所有新闻都转成事件。每条均保留短引、稳定锚点和来源 URL；目前都还是 `asserted`，没有因公司官网发布、具名对手方或同稿跨域转载而自动升级为独立确认。
...
| EV027 | Corning | 与 NVIDIA 联合稿提出美国光连接产能十倍、光纤产能提升逾 50% 的目标 | 两家公司官网是同一联合稿、同一 `origin_group`；只能计一个来源，且产能目标仍是前瞻 |
| EV028 | POET | 称 Lumilens 下达价值 5000 万美元 EOI 光引擎初始采购订单 | 只有 POET 一方披露；五年潜在采购额未作为已确认订单 |
